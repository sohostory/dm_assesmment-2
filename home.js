...
console.log("Problem 1:", greetUser("Hoyoung"));
...
function canWeDeliver(deliveryArea, zip) {
  let message = deliveryArea.includes(zip)
    ? "You're in our delivery zone!"
    : "Sorry, we can't deliver to that address";
...
console.log("Problem 2:", canWeDeliver(deliveryAreaZipCodes, 85205));
...
function canWeDeliverTwo(deliveryArea, zip) {
  let canWeDeliver = "Sorry, we can't deliver to that address";

  deliveryArea.forEach((zipCode) => {
    if (zipCode === zip) {
      canWeDeliver = "You're in our delivery zone!";
    }
  });
...
console.log("Problem 2:", canWeDeliverTwo(deliveryAreaZipCodes, 85205));
