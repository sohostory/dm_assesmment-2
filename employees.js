...
class Employee {
  ...
  getSchedule() {
    console.log("Problem 1:", `${this.name} works on ${this.shifts}`);
  }
}
...
class Manager extends Employee {
  ...
  getEmployees() {
    console.log("Problem 2:", `${this.name} manages ${this.employees}.`);
  }

  addEmployee(emp) {
    this.employees.push(emp);
    // console.log("Problem 2:", `${this.name} now manages ${this.employees}.`);
  }
}
/*
    Create a new instance of your class.
